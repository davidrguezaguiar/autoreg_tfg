...
class phpCAS
{
    ...
    */
    ...
    /**
     * Indica si el cliente CAS ya esta definido para no volver a instanciarse. En un principio se instanciara desde el AutenticadorCAS
     * @return bool
     */
    public static function clienteCASdefinido(){
